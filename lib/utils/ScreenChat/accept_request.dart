...
Future<void> acceptRequest(String recipentUID) async {
  log('Accepting Friend Request to: $recipentUID');
...
//-------Setting Request in Frnds Collection------------------
  ...
  sendMessage(type: 'relation', content: 'friends', recipentUID: recipentUID);

  log('Accepting Friend Request Comepleted');
}
