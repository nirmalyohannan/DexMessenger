...
setDeliveryStatusRecieved(MessageModel messageModel, String recipentUID) {
  String userUID = FirebaseAuth.instance.currentUser!.uid;

  if (userUID == messageModel.toUID && messageModel.deliveryStatus == 'send') {
    messageModel.deliveryStatus = 'recieved';
